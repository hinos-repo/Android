 ...
 */
public final class HinoIcyDataSource extends OkHttpDataSource {
    private static final String TAG = HinoIcyDataSource.class.getSimpleName();
...
//            metaDataIntervalInBytes =- bytesRead;
    ...
    public final static class Builder {
        ...
        HinoIcyDataSource build() {
            final HinoIcyDataSource dataSource =
                    new HinoIcyDataSource(callFactory,
                            userAgent,
